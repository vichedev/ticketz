      ...
      <Grid spacing={3} container>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            >
              <MenuItem value={"disabled"}>Reportar indisponibilidad</MenuItem>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            >
              ...
              <MenuItem value={"individual"}>Por usuario</MenuItem>
            </Select>
            <FormHelperText>
            ...
            <>
              ...
              <Grid xs={12} sm={6} md={4} item>
                <FormControl className={classes.selectContainer}>
                  <TextField
                    id="appname-field"
                    label="Limite de Download de archivos (MB)"
                    variant="standard"
                    name="appName"
                    value={downloadLimit}
