...
export default function HelpsManager () {
    ...
    const handleSubmit = async (data) => {
        ...
        try {
            ...
            toast.error('No fue posible realizar la operación. Comprobar si ya existe una ayuda con el mismo nombre o si los campos fueron rellenados correctamente')
        }
        setLoading(false)
    }
    ...
    return (
        <Paper className={classes.mainPaper} elevation={0}>
            ...
            >
                Desea realmente eliminar ese registro?
            </ConfirmationModal>
        </Paper>
    )
}