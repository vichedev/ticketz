...
export default function HelpsManager () {
    ...
    const loadHelps = async () => {
        ...
        try {
            ...
            toast.error('No se ha podido cargar la lista de registros')
        }
        setLoading(false)
    }
    ...
    const handleSubmit = async (data) => {
        ...
        try {
            ...
            await loadHelps()
            handleCancel()
            toast.success('Operación concluida con éxito.')
        } catch (e) {
            toast.error('No se ha podido realizar la operación. Compruebe si ya existe un helpo con el mismo nombre o si los campos se han rellenado correctamente')
        }
        setLoading(false)
    }
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            toast.error('No se ha podido realizar la operación')
        }
        setLoading(false)
    }
    ...
    return (
        <Paper className={classes.mainPaper} elevation={0}>
            ...
            <ConfirmationModal
                title="Cancelación del registro"
