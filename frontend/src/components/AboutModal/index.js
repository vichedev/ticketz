		...
		<div className={classes.root}>
			...
			>
				<DialogTitle id="form-dialog-title">
					{i18n.t("about.aboutthe")} {currentUser?.super ? "W-BOT" : theme.appName }
				</DialogTitle>
				<DialogContent dividers>
				{ currentUser?.super ? 
          <>
            <Typography variant="body1">{i18n.t("about.aboutdetail")}</Typography>
            <Typography><Link target="_blank" href="https://www.rednuevaconexion.net/">{i18n.t("about.aboutauthorsite")}</Link></Typography>
            <Typography><Link target="_blank" href="https://walink.co/f45a02">{i18n.t("about.aboutwhaticketsite")}</Link></Typography>
            <Typography><Link target="_blank" href="">{i18n.t("about.aboutvemfazersite")}</Link></Typography>
          ...
          <>
            ...
            <Typography className={classes.textCenter} ><Link target="_blank" href="">{i18n.t("about.copyright")}</Link></Typography>
          </>
        }
				</DialogContent>
				<DialogActions>
