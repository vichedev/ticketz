const messages = {
  es: {
    translations: {
      ...
      about: {
        aboutthe: "Acerca de",
        copyright: "© 2024 - W-BOT",
        buttonclose: "Cerrar",
        title: "Acerca de W-BOT",
        abouttitle: "Origen y Mejoras",
        aboutdetail: "W-Bot es un avanzado sistema de chatbot diseñado específicamente para integrarse con WhatsApp, proporcionando una experiencia de usuario fluida y eficiente. Este chatbot permite automatizar respuestas a consultas comunes, gestionar tareas rutinarias y ofrecer soporte personalizado en tiempo real.",
        aboutauthorsite: "Pagina de RNC",
        aboutwhaticketsite: "Contacto",
        aboutvemfazersite: "Inigualitysoft",
        licenseheading: "Ideal para tu Empresa",
        licensedetail: "W-Bot está comprometido con la innovación continua para ofrecer a sus usuarios las herramientas más avanzadas y eficientes."
      },
      schedules: {
        title: "Agendamientos",
        confirmationModal: {
